        ...
        <div class="flex justify-between h-16 w-full">
            <div class="flex justify-between w-full">
                ...
                <div class="hidden space-x-8 min-[850px]:-my-px min-[850px]:ms-10 min-[850px]:flex">
                    ...
                    <!-- Settings Dropdown -->
                    @auth
                        <div class="hidden min-[850px]:flex min-[850px]:items-center min-[850px]:ms-6">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-[rgb(var(--bg-rgb))] bg-[rgb(var(--fg-rgb))] hover:text-[rgba(var(--bg-rgb),0.85)] focus:outline-none transition ease-in-out duration-150">
