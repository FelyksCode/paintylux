    ...
    <form wire:submit="login">
        ...
        <div>
            ...
            <x-text-input wire:model="form.email" id="email"
                class="mt-1 block w-full" type="text" name="email" 
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="form.password" id="password"
                class="mt-1 block w-full" type="password" name="password"
                 autocomplete="current-password" wire:model.live.debounce.0ms="form.password" />

            @error('form.password') <x-input-error :messages="$message" class="mt-2" /> @enderror
        </div>

        <div class="mt-4 mb-4 flex flex-col space-y-3 items-center min-[360px]:space-y-0 min-[360px]:flex-row min-[360px]:justify-between">
            <!-- Forgot password -->
            ...
            <label for="remember" class="inline-flex items-center">
                <input wire:model="form.remember" id="remember" type="checkbox"
                    ...
                    name="remember">
                <span
                    class="ms-2 text-sm text-[rgb(var(--gray-rgb))]">{{ __('Ingat saya') }}</span>
            </label>
        </div>
        ...
        @error('form') <x-input-error :messages="$message" class="mt-2 text-center" /> @enderror
